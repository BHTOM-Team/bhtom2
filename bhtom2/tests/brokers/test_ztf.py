...
def create_sample_target() -> Target:
    ...
    target.save()
    TargetName.objects.create(target=target, source_name=DataSource.ZTF_DR8.name, name="1796284252615")
...
def create_second_sample_target() -> Target:
    ...
    target.save()
    TargetName.objects.create(target=target, source_name=DataSource.ZTF_DR8.name, name="1796284252616")
