...
def create_sample_target() -> Target:
    ...
    target.save()
    TargetName.objects.create(target=target, source_name=DataSource.AAVSO.name, name="Gaia20fnr")
...
def create_second_sample_target() -> Target:
    ...
    target.save()
    TargetName.objects.create(target=target, source_name=DataSource.AAVSO.name, name="Gaia21een")
