...
EMAILTEXT_REGISTEADMIN_TITLE: str = secret.get('EMAILTEXT_REGISTEADMIN_TITLE')
EMAILTEXT_REGISTEADMIN: str = secret.get('EMAILTEXT_REGISTEADMIN')
RECIPIENTEMAIL = [] + list(secret.get("RECIPIENTEMAIL").split(","))
SUCCESSFULLY_REGISTERED: str = secret.get('SUCCESSFULLY_REGISTERED')
EMAILTEXT_REGISTEUSER_TITLE: str = secret.get('EMAILTEXT_REGISTEUSER_TITLE')
EMAILTEXT_REGISTEUSER: str = secret.get('EMAILTEXT_REGISTEUSER')
EMAILTEXT_CREATE_OBSERVATORY_TITLE: str = secret.get('EMAILTEXT_CREATE_OBSERVATORY_TITLE')
EMAILTEXT_CREATE_OBSERVATORY: str = secret.get('EMAILTEXT_CREATE_OBSERVATORY')
EMAILTEXT_CREATE_OBSERVATORY_ADMIN: str = secret.get('EMAILTEXT_CREATE_OBSERVATORY_ADMIN')
EMAILTET_ACTIVATEUSER_TITLE: str = secret.get('EMAILTET_ACTIVATEUSER_TITLE')
EMAILTET_ACTIVATEUSER: str = secret.get('EMAILTET_ACTIVATEUSER')
TOMEMAIL: str  = secret.get('TOMEMAIL')
TOMEMAILPASSWORD: str = secret.get('TOMEMAILPASSWORD')
EMAILTEXT_ACTIVATEOBSERVATORY_TITLE: str = secret.get('EMAILTEXT_ACTIVATEOBSERVATORY_TITLE')
EMAILTEXT_ACTIVATEOBSERVATORY: str = secret.get('EMAILTEXT_ACTIVATEOBSERVATORY')
...
#ADS_API_KEY = secret.get('ADS_API_KEY', '')
ADS_API_KEY = "sg6G9mQErIkdgaJKsZnYJpsO9BpFzqCoKPIYDUys"