...
gunicorn --bind 0.0.0.0:8000 bhtom2.wsgi:application --log-level error --timeout 600 --workers 10 --threads 1 --access-logfile log/gunicorn/bhtom-access.log --error-logfile /log/gunicorn/bhtom-error.log -k gevent
exec "$@"
